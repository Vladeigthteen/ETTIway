...
săli concrete într-un corp pe care nu îl cunoști sunt sarcini care pot consuma
timp și pot conduce la întârzieri sau confuzii. Soluțiile generale de hărți
(Google Maps, OpenStreetMap) acoperă bine deplasarea între adrese, dar nu sunt
adaptate la nivelul de detaliu necesar într-un campus: nu arată sălile,
...
dezvoltată în mod intenționat pentru navigarea într-un campus universitar.
Aplicația oferă atât o componentă pentru spațiul exterior, cu hartă, căutare
și calcul de traseu pe aleile campusului, cât și o componentă pentru spațiul
...
acestui obiectiv au fost formulate mai multe obiective secundare, care au
...
pentru spațiul exterior al campusului, peste un strat de date provenit din
...
desena planurile de etaj ale clădirilor, iar un utilizator obișnuit poate
căuta o cameră și poate obține traseul către aceasta pe planul respectiv.
...
aplicația să funcționeze corect pe o varietate de dispozitive, de la laptop
și până la telefon mobil cu acces la internet.
...
abordare a permis identificarea și corectarea timpurie a problemelor și a
...
mare. Leaflet pentru afișarea hărții, datorita faptului că este o unealtă open-source și pentru
...
algoritmului Dijkstra, adaptată pentru lucrul cu coordonate pixel în loc de
