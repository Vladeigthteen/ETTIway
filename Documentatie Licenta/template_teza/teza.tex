...
Backend-ul aplicației este o aplicație Spring Boot, structurată pe pachete
...
Persistence API}), folosind abstracțiile oferite de Spring Data. În locul
...
Datele persistate sunt stocate într-o bază de date relațională PostgreSQL,
...
Securitatea este implementată folosind Spring Security, integrat nativ în
...
criptate folosind algoritmul BCrypt, prin intermediul unei componente dedicate
...
pentru afișarea hărții interactive. Pe lângă afișarea propriu-zisă, frontend-ul
...
construit pornind de la datele geografice exprimate în format GeoJSON, în care
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.45\textwidth]{figuri/mod_vizualizare.png}
    \hfill
  %  \includegraphics[width=0.45\textwidth]{figuri/mod_editare.png}
    \caption{Interfata in mod vizualizare (stanga) si in mod editare (dreapta)}
    \label{fig:moduri}
\end{figure}
...
\begin{figure}[H]
    \centering
   % \includegraphics[width=0.85\textwidth]{figuri/editare_harta.png}
    \caption{Editarea hartii de catre administrator: adaugarea unui nod si a unei legaturi}
    \label{fig:editare}
\end{figure}
...
\begin{figure}[H]
    \centering
   % \includegraphics[width=0.85\textwidth]{figuri/cautare_detalii.png}
    \caption{Rezultatul unei cautari si panoul de detalii al salii selectate}
    \label{fig:cautare}
\end{figure}
...
\begin{figure}[H]
    \centering
    %\includegraphics[width=0.8\textwidth]{figuri/traseu_harta.png}
    \caption{Traseu calculat si afisat pe harta intre doua puncte din campus}
    \label{fig:traseu}
\end{figure}
...
Soluția adoptată pentru ETTIway se bazează pe Tailscale, o rețea privată virtuală
(VPN) construită peste protocolul modern de criptare WireGuard. Spre deosebire de
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figuri/tailscale_devices.png}
    \caption{Dispozitivele inrolate in reteaua privata Tailscale}
    \label{fig:tailscale}
\end{figure}
...
folosind un certificat digital emis automat de Tailscale pentru numele
...
precum cea de geolocalizare folosită pentru obținerea poziției prin GPS, să poată
fi utilizate doar într-un context securizat (\textit{secure context}), adică
...
\begin{figure}[H]
    \centering
   % \includegraphics[width=0.4\textwidth]{figuri/telefon_https_gps.png}
    \caption{Aplicatia pe telefon: conexiune HTTPS securizata si pozitia GPS afisata pe harta}
    \label{fig:telefon}
\end{figure}
