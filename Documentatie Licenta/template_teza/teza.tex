...
interior al clădirilor, cu planuri de etaj editabile și rutare între camere
pe același etaj.
...
date geospațiale (în special GeoJSON), algoritmii de calcul al drumului
...
obișnuit, precum și controllerele REST care expun serviciile aplicației.
