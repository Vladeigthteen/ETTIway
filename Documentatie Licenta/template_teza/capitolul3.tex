...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{figuri/uml_flow_salvare.pdf}
...
Parametrii de retea include o adresa de IP statică în detrimnetulu protocolului de alocare
dinamic DHCP. Această alegere a fost facută pentru stabilitatea serverului si pentru a evita
probleme de conectivitate la restart sau in cazul in care se intrerupe alimentarea. Gatway-ul implicit este 
adresa de IP a ruterului din reteaua locală, care asigură conexiunea la internet pentru server.
...
Pe langă interfata fizica, serverul rulează clientul Tailscale, care creează o interfata virtuală spulimentară.
Aceasta interfață area atribuită o adresă IP  \texttt{100.X.X.X} rezervată de Tailscale pentru retele sale private.
Acastă adresă este atribuita din spațiul CGNAT (Carrier-Grade NAT, definit în RFC 6598) care este folosit tocmai 
...
modificărilor în baza de date. Totodată, a fost prezentată  si căutarea unificată a clădirilor și a camerelor
