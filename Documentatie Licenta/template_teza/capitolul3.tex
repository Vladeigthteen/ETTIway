...
(harta, căutarea, rutarea exterioară, indoor, autentificarea), care trebuie să
...
pe obiecte globale expuse pe obiectul \texttt{window}: \texttt{window.campusData},
...
sau Vue, ceea ce a permis păstrarea unei dependențe minime de cod extern și
...
nu înlocuiește protecția de pe server: chiar dacă cineva ar manipula codul
...
Pentru a rezolva această problemă, am configurat aplicația ETTIway ca
serviciu \texttt{systemd}, managerul de servicii standard pe distribuțiile
moderne de Linux. \texttt{systemd} este primul proces care pornește la
...
În al doilea rând, în caz de eșec al procesului Java (de exemplu, o eroare de
...
În al treilea rând, am ales să rulez aplicația sub un utilizator dedicat
...
privilege}: chiar dacă ar exista o vulnerabilitate exploatabilă în aplicație,
un eventual atacator ar obține doar drepturile limitate ale utilizatorului
\texttt{ettiway}, nu controlul complet asupra serverului. Această izolare
...
integrarea cu jurnalul centralizat \texttt{journalctl}, prin care toate
