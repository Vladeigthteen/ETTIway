...
\begin{lstlisting}[language=Java, caption={Definirea regulilor de autorizare (extras din SecurityConfig)}, label={lst:a6}]
@Bean
public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    http
        .csrf(csrf -> csrf
            .ignoringRequestMatchers("/api/graph/**")
            .disable()
        )
        .authorizeHttpRequests(auth -> auth
            
            .requestMatchers("/login.html", "/auth.html", "/api/auth/**",
                             "/css/**", "/js/**", "/icons/**", "/data/**").permitAll()
