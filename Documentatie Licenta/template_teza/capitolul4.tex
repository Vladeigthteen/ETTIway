...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.60\textwidth]{figuri/eroare_editare_user.png}
    \caption{Încercarea de acces la modul de editare din contul unui utilizator obișnuit}
    \label{fig:mod_editare_user}
\end{figure}
