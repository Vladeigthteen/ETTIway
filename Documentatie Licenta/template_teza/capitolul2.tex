...
backend, structura datelor persistate, mecanismul de autentificare și
autorizare, precum și fluxurile principale prin care componentele comunică între
ele. Deciziile de proiectare sunt motivate prin raportare la cerințele
formulate în capitolul anterior, cu accent pe extensibilitate, securitate și
claritate a fluxului de utilizare. Fragmentele de cod care ilustrează aceste
mecanisme se găsesc în Anexa~A (cod Java pentru backend) și Anexa~B (cod
JavaScript pentru frontend), pentru a păstra fluența capitolului fără a
sacrifica detaliile tehnice.
...
pentru frontend, atât timp cât contractul serviciilor este respectat. În
secțiunile următoare, fiecare nivel este analizat în detaliu.

\section{Nivelul de servicii (backend)}
\label{sec:backend}

Backend-ul aplicației este o aplicație Spring Boot \cite{Walls2022},
...
inițializare a datelor, descrisă în secțiunea dedicată autentificării, care
...
necesare. Pentru entitatea utilizator, repository-ul definește în plus o
...
\cite{PostgreSQL}, aleasă pentru maturitatea sa, pentru suportul robust al
tipurilor de date și pentru caracterul său deschis. Maparea dintre tabelele
...
atât informația despre exterior, cât și planurile de etaj din interior. S-a detaliat mecanismul de securitate, bazat pe Spring Security, cu
